...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_anonymous_anonymous_component__ = __webpack_require__("../../../../../src/app/components/anonymous/anonymous.component.ts");
...
var APP_ROUTES = [
    ...
    { path: 'anonymous', component: __WEBPACK_IMPORTED_MODULE_20__components_anonymous_anonymous_component__["a" /* AnonymousComponent */] }
];
    ...
    DriverEditComponent.prototype.updateDriver = function (username, password, verifyPassword, firstName, lastName, emailId) {
        ...
        if (verifyPassword !== password) {
            ...
            this.userService.updateUser(this.driverId, user)
                ...
                if (ride1) {
                    _this.router.navigate(['/user', _this.userId, 'admin', 'drivers']);
                }
            });
        }
    };
...
var ScheduleEditComponent = (function () {
    ...
    ScheduleEditComponent.prototype.updateRide = function (departureTime, selectedValue, vehicleNo, seatCount, blockedCount, origin, destination) {
        var _this = this;
        var ride = new __WEBPACK_IMPORTED_MODULE_1__models_ride_model_client__["a" /* Ride */](this.rideId, departureTime, selectedValue._id, selectedValue.firstname + " " + selectedValue.lastname);
...
var ScheduleNewComponent = (function () {
    ...
    ScheduleNewComponent.prototype.createRide = function (departureTime, selectedValue, vehicleNo, seatCount, blockedCount, origin, destination) {
        var _this = this;
        var ride = new __WEBPACK_IMPORTED_MODULE_1__models_ride_model_client__["a" /* Ride */]('', departureTime, selectedValue._id, selectedValue.firstname + " " + selectedValue.lastname);
        ride.seat_count = seatCount;
        ride.blocked_seats = blockedCount;
        ride.delay = 0;
        ride.origin = origin;
...
var ShortestpathComponent = (function () {
    ...
    ShortestpathComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            var queueSlot1 = new __WEBPACK_IMPORTED_MODULE_5__models_queueslot_model_client__["a" /* QueueSlot */](user1._id, user1.firstName + " " + user1.lastName, _this.rideId, dropoff_1);
            var queueSlot2 = new __WEBPACK_IMPORTED_MODULE_5__models_queueslot_model_client__["a" /* QueueSlot */](user2._id, user2.firstName + " " + user2.lastName, _this.rideId, dropoff_2);
            _this.queueSlots = [];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__services_ride_service_client__ = __webpack_require__("../../../../../src/app/services/ride.service.client.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyrideComponent = (function () {
    ...
    MyrideComponent.prototype.ngOnInit = function () {
        ...
        if ((this.sharedService.user != undefined && this.sharedService.user._queue != undefined)
            ...
            if (!Object(__WEBPACK_IMPORTED_MODULE_8_util__["isUndefined"])(this.sharedService.user)
                && !Object(__WEBPACK_IMPORTED_MODULE_8_util__["isUndefined"])(this.sharedService.user._queue)) {
    ...
    MyrideComponent.prototype.dropOffQueue = function () {
        ...
        this.queueService.deleteQueueSlot(this.queueSlot._id).subscribe(function (res) {
            _this.sharedService.user._queue = '';
