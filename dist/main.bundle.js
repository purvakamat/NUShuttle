...
var QueueSlotService = (function () {
    ...
    QueueSlotService.prototype.updateQueueSlot = function (queueSlotId, queueSlot) {
        var url = this.baseURLQueue + '/api/queue/' + queueSlotId;
        console.log(url);
