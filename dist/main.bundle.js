...
module.exports = "\r\n<nav class=\"navbar navbar-default navbar-fixed-top\">\r\n  <div class=\"container-fluid\">\r\n    <!--heading on the nav bar-->\r\n    <p class=\"navbar-header\">\r\n      <a class=\"navbar-brand thick\">\r\n        <b class=\"nav-foreground\">MY RIDE</b>\r\n      </a>\r\n    </p>\r\n\r\n    <!--chevron-->\r\n    <p class=\"navbar-text pull-left vertical-center\">\r\n      <a [routerLink]=\"['/rides']\" class=\"navbar-link\">\r\n        <span class=\"glyphicon glyphicon-chevron-left nav-foreground\"></span>\r\n      </a>\r\n    </p>\r\n  </div>\r\n</nav>\r\n\r\n<div class=\"container-fluid\">\r\n\r\n  <div *ngIf=\"showRideDetails\">\r\n    <p><b>Departure Time : </b> {{ride.departure_time | date:\"MM/dd/yyyy 'at' h:mm a\"}}</p>\r\n    <p><b>Vehicle No. : </b> {{ride.vehicle_no}}</p>\r\n    <p><b>Driver : </b> {{driver.firstName + \" \" + driver.lastName}}</p>\r\n    <p><b>Pick Up : </b> {{ride.origin}}</p>\r\n  </div>\r\n\r\n  <div class = \"row dropoff\">\r\n    <div class=\"col-xs-12\">\r\n      <input placeholder=\"Choose your dropoff location\"\r\n             autocorrect=\"off\"\r\n             autocapitalize=\"off\"\r\n             spellcheck=\"off\"\r\n             type=\"text\"\r\n             name=\"dropoff\"\r\n             [(ngModel)]=\"dropoff\"\r\n             class=\"form-control\"\r\n             #search [formControl]=\"searchControl\">\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row dropoff\">\r\n    <div class=\"col-xs-12\">\r\n      <agm-map [latitude]=\"latitude\" [longitude]=\"longitude\" [scrollwheel]=\"false\" [zoom]=\"16\" >\r\n        <agm-marker [latitude]=\"latitude\" [longitude]=\"longitude\" [iconUrl]=\"iconUrl\"></agm-marker>\r\n      </agm-map>\r\n    </div>\r\n  </div>\r\n\r\n  <div class=\"row dropoff\">\r\n    <div class=\"col-xs-12\">\r\n      <button type=\"button\" class=\"btn btn-success btn-block\" (click)=\"locationConfirmed()\">\r\n        {{showRideDetails? \"Confirm Drop Off Location\" : \"Change Drop Off Location\"}}\r\n      </button>\r\n    </div>\r\n  </div>\r\n\r\n</div>\r\n\r\n<!-- Footer -->\r\n<nav class=\"navbar navbar-default navbar-fixed-bottom\">\r\n  <div class=\"container-fluid\">\r\n    <p class=\"navbar-text pull-right\">\r\n      <a [routerLink]=\"['/profile']\" class=\"navbar-link\">\r\n        <span class=\"glyphicon glyphicon-user nav-foreground\"></span>\r\n      </a>\r\n    </p>\r\n  </div>\r\n</nav>\r\n"
...
var MyrideComponent = (function () {
    ...
    MyrideComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (!Object(__WEBPACK_IMPORTED_MODULE_8_util__["isUndefined"])(this.sharedService.user) && !Object(__WEBPACK_IMPORTED_MODULE_8_util__["isUndefined"])(this.sharedService.user._queue)) {
            ...
            this.queueService.findQueueSlotById(this.sharedService.user._queue)
                ...
                _this.rideService.findRideById(_this.sharedService.selectedRide).subscribe(function (ride) {
                    _this.ride = ride;
                    _this.fetchDriverForRide(_this.ride);
                });
            });
        }
        // create search FormControl
    ...
    MyrideComponent.prototype.fetchDriverForRide = function (ride) {
        var _this = this;
    ...
    MyrideComponent.prototype.locationConfirmed = function () {
        var _this = this;
        var slot = new __WEBPACK_IMPORTED_MODULE_6__models_queueslot_model_client__["a" /* QueueSlot */](this.sharedService.user._id, this.sharedService.selectedRide, this.dropOff);
...
var QueueSlotService = (function () {
    ...
    QueueSlotService.prototype.findQueueSlotById = function (slotId) {
        var url = this.baseURLRide + '/' + slotId;
        return this.http.get(url)
            .map(function (response) {
            return response.json();
        });
