...
var PickupComponent = (function () {
    function PickupComponent(http) {
        this.http = http;
        this.baseUrl = 'https://maps.googleapis.com/maps/api/geocode/json?address=ADDRESS&key=YOUR_API_KEY';
        this.key = 'AIzaSyBGG-wkSH660bvqdSp-zIByzIzYPGqvfiQ';
    }
    PickupComponent.prototype.ngOnInit = function () {
    };
    PickupComponent.prototype.searchLocation = function () {
        var url = this.baseUrl
            .replace('YOUR_API_KEY', this.key)
            .replace('ADDRESS', this.pickupAddress);
